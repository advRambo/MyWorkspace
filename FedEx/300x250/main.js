...
function initAd() {
  ...
  //---------- START ANIMATION ------------
  tl.addLabel("start")
    .set("#c1_a, #c1_b, #c1_c, #c2_a, #c2_b, #c2_c, #c2_d, #ctaCopy, #ctaArrow, #legal", { opacity: 0, force3D: true })
    .set(" #c1_a, #c1_b, #c1_c, #c2_a, #c2_b, #c2_c, #c2_d", { x: 80, force3D: true })
  ...
  tl.addLabel("frame1", "")
    ...
    .staggerTo(" #legal", .5, { x: 0, opacity: 1, ease: Quad.easeOut }, .1, "frame1+=1.2");
  ...
  tl.addLabel("frame2", "3.5")
    ...
    .staggerTo("#c2_b, #c2_c, #c2_d", .5, { x: 0, opacity: 1, ease: Quad.easeOut }, .1, "frame2+=1.1")
    .staggerTo("#ctaCopy, #ctaArrow", 1.0, { x: "0", opacity: 1, ease: Power1.easeInOut }, 0, "frame2+=2.0")
    .fromTo('#ctaArrow', .5, { x: "0" }, { rotationZ: '0deg', x: 10, ease: Quad.easeOut, force3D: true }, "frame2+=2.9")
    .to('#ctaArrow', .3, { rotationZ: '0deg', x: 0, ease: Quad.easeIn }, "frame2+=3.4");
