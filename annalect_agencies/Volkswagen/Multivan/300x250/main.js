...
function initAd() {
  ...
  //---------- START ANIMATION ------------
  tl.addLabel("start")
    .set("#text1,#bg2,#text2,#bg3,#text3,#greyBox,#dealerList,#carDiv,#leftWheelBox,#rightWheelBox,#logoBlue,#ctaBlueBox,#disclaimer_container,#tc_close,#tc_open,#ctaBox", { opacity: 0, force3D: true })
    .set("#bg1,#bg2", { scale: 1.2, transformOrigin: '70% 60%', force3D: true })
  ...
  tl.addLabel("frame2", "3.1")
    ...
    .to('#bg1', 0.1, { opacity: 0, transformOrigin: '70% 60%', scale: 1.2, rotationZ: 0.001, ease: Power0.easeInOut }, "frame2+=1")
    .to("#text2", 0.5, { opacity: 1, ease: Power0.easeInOut }, "frame2+=0.1")
  // .to("#price", 0.5, { opacity: 1, ease: Power0.easeInOut }, "frame2+=2.1")
  ...
  //---------- Frame 4 ------------
  tl.addLabel("frame4", "11")
    .to("#logoWhite,#bg1,#text3,#tc_open,#ctaBox,#ctaCopy", 0.3, { opacity: 0, ease: Power0.easeInOut }, "frame4")
    .to("#tc_open", 0, { zIndex: 0 }, "frame4")
    .to("#logoBlue,#greyBox", 0.3, { opacity: 1, ease: Power0.easeInOut }, "frame4+=0.3")
