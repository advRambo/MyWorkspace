...
function initAd() {
  ...
  tl.addLabel("start")
    ...
    .set("#bg1", { scale: 1.2, y: 0, transformOrigin: '70% 60%', force3D: true })
    .set("#bg2", { x: 0, y: -8 })
    .set("#text3Box", { x: 100 })
  ...
  tl.addLabel("frame1", "0.2")
    ...
    .to("#bgFrame", 0.3, { height: 120, ease: Power3.easeOut }, "frame1")
    ...
    .to('#bg1', 2.75, { scale: 1, rotationZ: 0.001, ease: Linear.easeInOut }, "frame1+=0.25")
  ...
  tl.addLabel("frame2", "5")
    ...
    .to('#bg2', 3, { x: -35, rotationZ: 0.001, ease: Power3.ease }, "frame2+=0.1")
  ...
  tl.addLabel("frame3", "10")
    .to("#text2", 0.2, { opacity: 0, ease: Power4.easeOut }, "frame3")
    .to("#bg3", 0.2, { opacity: 1, ease: Power4.easeIn }, "frame3")
    .to("#text3Box", 0.5, { x: 0, ease: Power2.easeOut }, "frame3+=0.3")
    .to('#bg3', 3.9, { scale: 1.17, x: 6, y: 2, rotationZ: 0.001, ease: Linear.easeInOut }, "frame3+=0.2")
