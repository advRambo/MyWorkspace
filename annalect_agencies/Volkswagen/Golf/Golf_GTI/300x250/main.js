var tl = new TimelineMax({ onComplete: endFrame, repeat: 2, repeatDelay: 2 });
...
function initAd() {
  ...
  tl.addLabel("frame1", "0.2")
    ...
    .to('#bg1', 2.75, { x: -45, rotationZ: 0.001, ease: Power3.ease }, "frame1+=0.25")
  ...
  tl.addLabel("frame3", "10")
    ...
    // .to("#text2", 0.2, { opacity: 0, ease: Power4.easeInOut }, "frame3")
    .to("#bg3", 0.2, { opacity: 1, ease: Power4.easeIn }, "frame3")
    .to('#bg3', 3.9, { scale: 1.15, rotationZ: 0.001, ease: Linear.easeInOut }, "frame3+=0.2")
