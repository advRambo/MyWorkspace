...
function initAd() {
  ...
  //---------- START ANIMATION ------------
  tl.addLabel("start")
    .set("#line1,#line2,#line3,#line4,#line5,#logo1,#logo2,#legalCopy1,#frame2,#frame3,#frame4,#frame5,#plus2,#plus3,#equals,#ctaBox", { opacity: 0, force3D: true })
    .set("#line1,#line2,#line3", { x: 30 })
    .set("#bg", { scale: 1.2, rotationZ: 0.001 })
    .set("#frame2,#frame3,#frame4,#frame5,#logo2,#ctaBox", { x: 300 })
  ...
  tl.addLabel("frame3", "7.3")
    ...
    .to("#plus3", 1.15, { x: -201, opacity: 1, ease: Power3.easeOut }, "frame3")

  // ----------Frame 4 ------------
  tl.addLabel("frame4", "10.3")
    .to("#plus2", 1.15, { x: -699, ease: Power3.easeOut }, "frame4")
    .to("#plus3", 1.15, { x: -499, ease: Power3.easeOut }, "frame4")
    .to("#frame3", 0.75, { x: -300, ease: Power1.easeOut }, "frame4")
    .to("#frame4", 0.75, { x: 0, opacity: 1, ease: Power1.easeOut }, "frame4")
    .to("#equals", 1.15, { x: -199, opacity: 1, ease: Power3.easeOut }, "frame4")

  // ----------Frame 5 ------------
  tl.addLabel("frame5", "13.3")
    .to("#plus3", 1.15, { x: -699, ease: Power3.easeOut }, "frame5")
    .to("#frame4,#logo2", 0.75, { x: -300, ease: Power1.easeOut }, "frame5")
    .to("#frame5,#ctaBox", 0.75, { x: 0, opacity: 1, ease: Power1.easeOut }, "frame5")
    .to("#equals", 1.15, { x: -502, opacity: 1, ease: Power3.easeOut }, "frame5")
