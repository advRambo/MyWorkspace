...
function zoom_in(a) {
	zoom_tl = new TimelineMax()
		.to(a, 12, { scale: 1.02, x: '-=0px', transformOrigin: '45% 50%', rotation: 0.01, ease: Power1.easeOut, force3D: false });
}

function zoom_in_delay(a) {
	zoom_tl = new TimelineMax()
		.to(a, 10, { delay: 1, scale: 1.02, x: '-=0px', transformOrigin: '20% 50%', rotation: 0.01, ease: Power1.easeOut, force3D: false });
}
