...
function zoom_delay(a) {
	new TimelineMax()
		.from(a, 11, {delay:2, scale:1.1, transformOrigin:'50% 50%', rotation: 0.01, force3D: true});
}
...
banner.maintimeline = function(){
    ...
    .add(fadeIn(hover_link,0.5),'+=0.25')
    ...
    .add(fadeIn(overlay, 0.5),'+=2.25')
		
		.add(fadeIn_up([cta_container]),'+=0.25')
    .add(fadeIn(symbol, 0.5),'+=0.25')
